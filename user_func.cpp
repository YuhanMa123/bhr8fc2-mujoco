...
const float p_gains[2][10] = {
    {150., 150, 200., 200., 40., 40., 100., 100., 100., 100.},
    {150., 150, 200., 200., 40., 40., 100., 100., 100., 100.}};  // zyx-231007

const float d_gains[2][10] = {
    {2.5, 2.5, 2.5, 4., 2., 2., 2.0, 2.0, 2.0, 2.0},
    {2.5, 2.5, 2.5, 4., 2., 2., 2.0, 2.0, 2.0, 2.0}};  // zyx-231007
